  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-black text-slate-900 dark:text-slate-100 tracking-tight">F&I Protection Suite</h3>
            ...
            <motion.div 
              ...
              className={cn(
                ...
                isActive 
                  ...
                  : "border-slate-200 dark:border-slate-700/50 bg-slate-800/50 hover:border-slate-600"
              )}
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h4 className="font-black text-slate-900 dark:text-slate-100">{product.name}</h4>
                      {product.recommended && (
                ...
                <div className="text-right flex flex-col items-end gap-2">
                   <div className="flex flex-col items-end">
                      <span className="text-lg font-black text-slate-900 dark:text-slate-100">${product.price.toLocaleString()}</span>
