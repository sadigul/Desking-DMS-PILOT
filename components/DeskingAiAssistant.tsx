      ...
      <CardContent className="p-4">
        {!vehicle ? (
          ...
          <div className="text-center py-6">
             ...
             <p className="text-sm font-bold text-slate-700 mb-1">Waiting for data...</p>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
               <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                  ...
                  <p className="text-sm font-black text-slate-900">${suggestion.price?.toLocaleString()}</p>
               </div>
               <div className="bg-slate-50 p-2.5 rounded-xl border border-slate-100">
                  <p className="text-[9px] font-black uppercase text-slate-400 mb-1">Rec. APR</p>
                  <p className="text-sm font-black text-slate-900">{suggestion.sellRate}%</p>
               </div>
            </div>
