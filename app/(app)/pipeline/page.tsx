    ...
    <div className="space-y-4 max-w-full overflow-x-hidden pb-10">
      ...
      <div className="space-y-3">
        {displayColumns.map(col => {
          ...
          return (
            <Card key={col} className="border-slate-700/50 rounded-xl overflow-hidden">
              {/* Column Header */}
              <button onClick={() => toggleCol(col)} className="w-full flex items-center justify-between p-3.5 hover:bg-slate-700/30/50 transition-colors">
                <div className="flex items-center gap-2.5">
                  ...
                  <h3 className="text-sm font-semibold text-slate-200">{col}</h3>
                  <Badge variant="secondary" className="text-[10px] h-5 px-1.5 bg-slate-700/50">{deals.length} deals</Badge>
                ...
                <div className="px-3.5 pb-3.5 grid sm:grid-cols-2 xl:grid-cols-3 gap-2.5">
                  {deals.map(deal => (
                    <motion.div
                      ...
                      className="p-3 rounded-lg border border-slate-700/50 bg-slate-800/50 hover:border-slate-600 hover:shadow-sm transition-all cursor-pointer"
                    >
                      ...
                      <div className="flex items-center gap-3 mt-2.5 pt-2 border-t border-slate-700/50">
                      ...
                      <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-50">
                        <div className="flex items-center gap-1.5">
                          <div className="w-5 h-5 rounded-md bg-slate-700/50 flex items-center justify-center text-[9px] font-medium text-slate-500">
