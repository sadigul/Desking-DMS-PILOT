    ...
    <div className="space-y-4 max-w-full overflow-x-hidden pb-10">
        ...
        <div className="px-5 pb-5 -mt-12 relative">
          <div className="flex flex-col sm:flex-row sm:items-end gap-4">
            <div className="relative">
              <div className="w-24 h-24 rounded-2xl bg-white dark:bg-slate-800/50 border-4 border-white shadow-lg flex items-center justify-center overflow-hidden">
              ...
              <button className="absolute -bottom-1 -right-1 w-7 h-7 bg-white dark:bg-slate-800/50 border-2 border-slate-700 rounded-lg flex items-center justify-center hover:bg-slate-700/50 transition-colors">
                <Camera className="w-3.5 h-3.5 text-slate-500" />
              </button>
            </div>
            <div className="flex-1 min-w-0 sm:pb-1">
              <div className="flex items-center gap-2 flex-wrap">
                <h2 className="text-lg font-bold text-slate-900 dark:text-slate-100">Marcus Williams</h2>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-4">
        ...
        <div className="xl:col-span-5 space-y-4">
          <Card className="border-slate-200 dark:border-slate-700/50 rounded-xl">
          ...
          <Card className="border-slate-200 dark:border-slate-700/50 rounded-xl">
            <div className="p-4 border-b border-slate-100">
              <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Permissions & Access</h3>
            </div>
        ...
        <div className="xl:col-span-7 space-y-4">
          ...
          <Card className="border-slate-200 dark:border-slate-700/50 rounded-xl">
            <div className="p-4 border-b border-slate-100">
              <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Performance — May 2026</h3>
            </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  ...
                  <div key={i} className="p-3 rounded-xl border border-slate-100 text-center">
                    ...
                    <p className="text-lg font-bold text-slate-900 dark:text-slate-100">{k.value}</p>
          ...
          <Card className="border-slate-200 dark:border-slate-700/50 rounded-xl">
            <div className="p-4 border-b border-slate-100">
              <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Certifications & Training</h3>
            </div>
